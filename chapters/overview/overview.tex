...
$\bullet$ \textbf{Forecasting  and Replenishment}: The firm provides forecasts and replenishment
...
$\bullet$ \textbf{Assortment and Space Optimization}: Predictix helps retailers to define the
...
$\bullet$ \textbf{Planning and  Allocation}: Business Consulting at Predictix helps retailers
...
$\bullet$ \textbf{LogicBlox}: The platform provider for Predictix' solutions. Predictix used
...
$\bullet$ \textbf{Amazon Web Services}: AWS is a world leader in cloud computing
